...
public class PinPadInterface {
    ...
    public native static int updateCipherMasterKey(int nMasterKeyID, byte arrayCipherMasterKey[], int nCipherMasterKeyLen, byte arrayCheckValue[], int nCheckValueLen);
	...
	public static void pinpadCallback(byte[] data) {
		...
		if (callbackHandler != null) {
			callbackHandler.processCallback(tempByte);
		}
	}
}
