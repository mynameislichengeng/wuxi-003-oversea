                        ...
                        public void uncaughtException(Thread thread, final Throwable throwable) {
                            ...
                            if (isStackTraceLikelyConflictive(throwable, errorActivityClass)) {
                                ...
                                if (launchErrorActivityWhenInBackground || !isInBackground) {
                                    ...
                                    PaymentApplication.resetAppState(); //增加重置 AppState wu@[20151123]

                                	final Intent intent;
                                    if(Constants.DEBUGING){//测试模式下跳转到错误提示界面,否则直接重启应用 wu@[20150812]
                                		intent = new Intent(application, errorActivityClass);
                                		...
                                		intent = new Intent(application, restartActivityClass);
                                	}
                    ...
                    if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
                        application.registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                            ...
                            public void onActivityCreated(Activity activity, Bundle savedInstanceState) {
                            	LogEx.d("activity", "onActivityCreated: " + activity.getClass().getName());
//                            	Log.d("activity", "onActivityCreated: " + activity.getClass().getName() );
...
//                            	LogEx.d("activity", "onActivityStarted: " + activity.getClass().getName() );
...
//                            	LogEx.d("activity", "onActivityResumed: " + activity.getClass().getName() );
                                //Do nothing
                            }

                            @Override
                            public void onActivityPaused(Activity activity) {
//                            	LogEx.d("activity", "onActivityPaused: " + activity.getClass().getName() );
                                //Do nothing
                            }

                            @Override
                            public void onActivityStopped(Activity activity) {
//                            	LogEx.d("activity", "onActivityStopped: " + activity.getClass().getName() );
                                //Do nothing
                                currentlyStartedActivities--;
                                isInBackground = (currentlyStartedActivities == 0);
                            }
...
//                            	LogEx.d("activity", "onActivitySaveInstanceState: " + activity.getClass().getName() );
                                //Do nothing
                            }

                            @Override
                            public void onActivityDestroyed(Activity activity) {
                            	LogEx.d("activity", "onActivityDestroyed: " + activity.getClass().getName() );
                                //Do nothing
                            }
                        });
                    }
