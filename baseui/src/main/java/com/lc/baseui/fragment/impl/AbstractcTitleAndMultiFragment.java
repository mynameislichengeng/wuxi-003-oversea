...
public abstract class AbstractcTitleAndMultiFragment<T> extends BaseViewPagerFragment<T> implements BaseRecycleAdapter.OnItemClick, HttpClientImplListener<T> {
