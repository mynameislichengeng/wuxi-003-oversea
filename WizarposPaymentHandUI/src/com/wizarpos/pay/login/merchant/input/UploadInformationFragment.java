 ...
 * @Description:资料上传
 */
public class UploadInformationFragment extends BaseViewFragment{
	...
	public void initView() {
		...
		iv1 = (ImageView) mainView.findViewById(R.id.iv_photo1);
		iv2 = (ImageView) mainView.findViewById(R.id.iv_photo2);
		iv3 = (ImageView) mainView.findViewById(R.id.iv_photo3);
		mainView.findViewById(R.id.iv_photo1).setOnClickListener(this);
		mainView.findViewById(R.id.iv_photo2).setOnClickListener(this);
		mainView.findViewById(R.id.iv_photo3).setOnClickListener(this);
	...
	public void onClick(View view) {
		...
		switch (view.getId()) {
		case R.id.iv_photo1:
			rl_pop_parent = (RelativeLayout) mainView.findViewById(R.id.rl_pop_parent1);
			location = new int[2];  
			...
			break;
		case R.id.iv_photo2:
			rl_pop_parent = (RelativeLayout) mainView.findViewById(R.id.rl_pop_parent2);
			location = new int[2];  
			rl_pop_parent.getLocationInWindow (location);
			x_offset = location[0];
			y_offset = location[1];
			...
			break;
		case R.id.iv_photo3:
			rl_pop_parent = (RelativeLayout) mainView.findViewById(R.id.rl_pop_parent3);
			location = new int[2];  
			rl_pop_parent.getLocationInWindow (location);
			x_offset = location[0];
			y_offset = location[1];
		...
		case R.id.btn_next://下一步
			...
			{
				//TODO
				((NewMerChantFillFormActivity)getActivity()).toFragmentAndSave(new NewMerchantFragment(),NewMerChantFillFormActivity.UPLOADINFORMATION_FRAGMENT_FLAG);
	            ...
	            case CAMERA_SELECT:  
	                ...
	                try {  
	                    ...
	                    Bitmap photo = MediaStore.Images.Media.getBitmap(resolver,  
	                            imgUri);  
	                    showPhoto(photo,FileUtil.getImageAbsolutePath(getActivity(), imgUri));
	                } catch (Exception e) {  
	                	e.printStackTrace(); 
	                }  
