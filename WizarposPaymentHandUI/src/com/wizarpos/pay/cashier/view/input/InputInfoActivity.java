 ...
 *
 */
public class InputInfoActivity extends BaseViewActivity implements InputInfoListener {
...
//		getMenuInflater().inflate(R.menu.input_member_card, menu);
	...
	private void showQRCodeFragment() {
		...
		scanIntent.setClass(InputInfoActivity.this, InputInfoCameraActivity.class);
	...
	private void showTextFragment() {
		...
		transaction.show(inputInfoTextFragment);
		if(title!=null && title.equals("券使用")) {
			inputInfoTextFragment.setInputMsg("请输入微信券号");
		}
		transaction.commit();
		inputInfoSwipeFragment.closeCardListener();
	}
