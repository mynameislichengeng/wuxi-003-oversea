...
import com.wizarpos.pay.view.DemoView;
...
public class PieChart01View extends DemoView implements Runnable{
	...
	public PieChart01View(Context context, ArrayList<PieData> chartData) {
		super(context);
	...
	private void chartRender()
	{
		try {					
			...
			chart.getBorder().setBorderLineColor(0xFF000000);
