package com.wizarpos.pay.view.smooth;

import static com.wizarpos.pay.view.smooth.SmoothProgressBarUtils.checkColors;
import static com.wizarpos.pay.view.smooth.SmoothProgressBarUtils.checkNotNull;
import static com.wizarpos.pay.view.smooth.SmoothProgressBarUtils.checkPositive;
import static com.wizarpos.pay.view.smooth.SmoothProgressBarUtils.checkPositiveOrZero;
import static com.wizarpos.pay.view.smooth.SmoothProgressBarUtils.checkSpeed;
...
public class SmoothProgressDrawable extends Drawable implements Animatable {
	...
	private SmoothProgressDrawable(Interpolator interpolator, int sectionsCount, int separatorLength, int[] colors, float strokeWidth, float speed,
			float progressiveStartSpeed, float progressiveStopSpeed, boolean reversed, boolean mirrorMode, Callbacks callbacks,
	...
	private void drawGradient(Canvas canvas) {
		...
		LinearGradient linearGradient = new LinearGradient(left, top, right, bottom, mLinearGradientColors, mLinearGradientPositions,
	...
	private void checkColorIndex(int index) {
		if (index < 0 || index >= mColors.length) { throw new IllegalArgumentException(String.format("Index %d not valid", index)); }
	}
	...
	public static class Builder {
		...
		public SmoothProgressDrawable build() {
			...
			SmoothProgressDrawable ret = new SmoothProgressDrawable(mInterpolator, mSectionsCount, mStrokeSeparatorLength, mColors, mStrokeWidth, mSpeed,
					mProgressiveStartSpeed, mProgressiveStopSpeed, mReversed, mMirrorMode, mOnProgressiveStopEndedListener, mProgressiveStartActivated,
