package com.wizarpos.pay.view.swipyrefresh;
 ...
 * provide accessibility events; instead, a menu item must be provided to allow refresh of the content wherever this gesture is used.
 * </p>
 */
...
//	private static final int CIRCLE_BG_LIGHT = 0xFFFAFAFA;
	...
	/**
	 * The refresh indicator starting and resting position is always positioned near the top of the refreshing content. This position is a consistent location,
	 * but can be adjusted in either direction based on whether or not there is a toolbar or actionbar present.
	 * 
	 * @param scale
	 *            Set to true if there is no view at a higher z-order than where the progress spinner is set to appear.
	 * @param start
	 ...
	 */
	/*
	 * public void setProgressViewOffset(boolean scale, int start, int end) { mScale = scale; mCircleView.setVisibility(View.GONE); mOriginalOffsetTop =
	 * mCurrentTargetOffsetTop = start; mSpinnerFinalOffset = end; mUsingCustomStart = true; mCircleView.invalidate(); }
	 */

	/**
	 * The refresh indicator resting position is always positioned near the top of the refreshing content. This position is a consistent location, but can be
	 * adjusted in either direction based on whether or not there is a toolbar or actionbar present.
	 * 
	 * @param scale
	 *            Set to true if there is no view at a higher z-order than where the progress spinner is set to appear.
	 * @param end
	 ...
	 */
	/*
	 * public void setProgressViewEndTarget(boolean scale, int end) { mSpinnerFinalOffset = end; mScale = scale; mCircleView.invalidate(); }
	 */
	...
	public void setSize(int size) {
		if (size != MaterialProgressDrawable.LARGE && size != MaterialProgressDrawable.DEFAULT) { return; }
	...
	public SwipyRefreshLayout(Context context, AttributeSet attrs) {
		...
		SwipyRefreshLayoutDirection direction = SwipyRefreshLayoutDirection.getFromInt(a2.getInt(R.styleable.SwipyRefreshLayout_direction, 0));
